	...
	return (
		<Tab>
			<TabHeader className="flex justify-between items-center">
				<h3 className="text-vscode-foreground m-0">{t("mcp:mcpServers")}</h3>
					...
					<>
						<div style={{ marginBottom: 15 }}>
							<VSCodeCheckbox
								...
								<span style={{ fontWeight: "500" }}>{t("mcp:enableMcpServerCreation")}</span>
							</VSCodeCheckbox>
							<p
								style={{
									fontSize: "12px",
...
const ServerRow = ({ server, alwaysAllowMcp }: { server: McpServer; alwaysAllowMcp?: boolean }) => {
	...
	const timeoutOptions = [
		{ value: 15, label: t("mcp:timeoutOptions.15") },
		{ value: 30, label: t("mcp:timeoutOptions.30") },
		{ value: 60, label: t("mcp:timeoutOptions.60") },
		{ value: 300, label: t("mcp:timeoutOptions.300") },
		{ value: 600, label: t("mcp:timeoutOptions.600") },
		{ value: 900, label: t("mcp:timeoutOptions.900") },
		{ value: 1800, label: t("mcp:timeoutOptions.1800") },
		{ value: 3600, label: t("mcp:timeoutOptions.3600") },
	]
	...
	return (
		<div style={{ marginBottom: "10px" }}>
					...
					<div
						...
						<div style={{ padding: "10px 7px" }}>
							<div
								...
								<span>{t("mcp:networkTimeout")}</span>
								<select
									value={timeoutValue}
			...
			<Dialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
				<DialogContent>
					<DialogHeader>
						<DialogTitle>{t("mcp:deleteMcpServer")}</DialogTitle>
						<DialogDescription>
							{t("mcp:deleteServerConfirmation", { name: server.name })}
						</DialogDescription>
					</DialogHeader>
					<DialogFooter>
